...
However, the HR team does not have clear visibility into which job roles are experiencing the highest employee attrition.  
Because of this, it becomes difficult to make effective hiring, retention, and workforce planning decisions.  
...
- The estimated business cost caused by employee exits
...
1. Replacement cost is estimated as a percentage of annual salary based on employee job level.  
   Employees in higher job levels are assumed to cost more to replace due to hiring, onboarding, training, and productivity loss.
...
2. Attrition levels were classified using the following business rules:
...
- **Sales Executives** had a lower attrition rate (**17%**) but contributed the highest replacement cost at approximately **₹35.7 Lakhs**, accounting for nearly **69%** of the total replacement cost.  
...
3. **Improve Retention of New Employees**  
   ...
   The company should focus more on improving the experience of employees during their first few years in these roles to reduce early exits.
